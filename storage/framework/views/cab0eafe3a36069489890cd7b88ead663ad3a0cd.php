            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i><span><?php echo e(trans('file.Purchase')); ?></span></a>
                <ul id="purchase" class="collapse list-unstyled ">
                  <li id="purchase-list-menu"><a href="<?php echo e(route('purchase.index')); ?>"><?php echo e(trans('file.Purchase List')); ?></a></li>
                  <?php 
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li id="purchase-create-menu"><a href="<?php echo e(route('purchase.create')); ?>"><?php echo e(trans('file.Add Purchase')); ?></a></li>
                  <li id="purchase-import-menu"><a href="<?php echo e(url('purchase/purchase_by_csv')); ?>"><?php echo e(trans('file.Import Purchase By CSV')); ?></a></li>
                  <?php endif; ?>
                </ul>
              </li>
              <?php endif; ?>
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  <?php if($index_permission_active): ?>
                  <li id="sale-list-menu"><a href="<?php echo e(route('sale.index')); ?>"><?php echo e(trans('file.Sale List')); ?></a></li>
                  <?php 
                  ...
                  <li id="sale-create-menu"><a href="<?php echo e(route('sale.create')); ?>"><?php echo e(trans('file.Add Sale')); ?></a></li>
                  <li id="sale-import-menu"><a href="<?php echo e(url('sale/sale_by_csv')); ?>"><?php echo e(trans('file.Import Sale By CSV')); ?></a></li>
                  <?php endif; ?>
                  <?php endif; ?>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item"> 
                    <a class="dropdown-item" href="read_me" target="_blank"><i class="fa fa-info-circle"></i> <?php echo e(trans('file.Help')); ?></a>
                </li>&nbsp;
                <li class="nav-item">
